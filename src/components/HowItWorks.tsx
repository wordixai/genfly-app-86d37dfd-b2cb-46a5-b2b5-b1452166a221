          ...
          <div className="w-full max-w-56 pt-4 md:px-2 flex flex-col gap-3">
            ...
            {step.transactions && (
              <div className="space-y-2">
                {step.transactions.map((transaction, i) => (
                  <div key={i} className="h-6 bg-primary/5 rounded flex items-center px-2">
